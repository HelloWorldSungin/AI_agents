...
1. **Holistic Design**: Consider all context elements as interconnected components
2. **Iterative Refinement**: Continuously test and optimize context configurations
3. **User-Centric Focus**: Design contexts that serve real user needs and workflows
4. **Scalability**: Build context systems that can handle varying complexity levels
5. **Maintainability**: Create context architectures that can evolve with requirements
...
1. Explain specific limitations
